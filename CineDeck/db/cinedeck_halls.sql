...
CREATE TABLE `halls` (
  ...
  `halls` int NOT NULL,
  `showtimings` datetime NOT NULL,
  `showend` datetime NOT NULL,
  `reg` varchar(1000) DEFAULT NULL,
  `vip` varchar(1000) DEFAULT NULL,
  `vipb` varchar(1000) DEFAULT NULL,
  `prem` varchar(1000) DEFAULT NULL,
  PRIMARY KEY (`halls`,`showtimings`,`showend`)
